 ...
 */
export function SHA256(message:string|Uint8Array|Buffer, options?:Options) {;
    var message2:number[] = []
    if (message.constructor === String) {
        message2 = stringToBytes(message as string);
    } else {
        message2 = <unknown> message as number[]
    }
 ...
 * @returns ```string|Uint8Array|Buffer```
 */
export function SHA224(message:string|Uint8Array|Buffer, options?:Options) {;
    var message2:number[] = []
    if (message.constructor === String) {
        message2 = stringToBytes(message as string);
    } else {
