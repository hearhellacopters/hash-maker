...
function _getMessage(buffer: Buffer | Uint8Array, tiger2?: boolean): bigint[] {
    const words: bigint[] = [];
    let word = BigInt(0);
...
function writeUint64(buf: Uint8Array, value: bigint, isLittleEndian: boolean, offset: number) {
...
export class Tiger {
     ...
     */
    constructor(
        digestBitLen: number = 128, // 128, 160, 192
        extraPasses: number = 0,
        bigEndian: boolean = false,
        tiger2: boolean = false,
    ) {
        if (!inited) {
            t1 = [
    ...
    _round(a: { value: bigint }, b: { value: bigint }, c: { value: bigint }, x: bigint, mul: bigint) {
        c.value ^= x;
        const d = c.value;
    ...
    _pass(a: { value: bigint }, b: { value: bigint }, c: { value: bigint }, mul: bigint) {
    ...
    _split(message: bigint[], block: number) {
 ...
 */
export function _TIGER(message: InputData, format: OutputFormat = arrayType(), bitLen: 128 | 160 | 192 = 192, extraPasses: number = 0, bigEndian: boolean = false): string | Uint8Array | Buffer {
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType(), bitLen: 128 | 160 | 192 = 192, extraPasses: number = 0, bigEndian: boolean = false): string | Uint8Array | Buffer {
    const key_length = 64;
    const hash_len = bitLen / 8;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = _TIGER(key, "array", bitLen, extraPasses, bigEndian) as Uint8Array;
    }
    ...
    result.set(_TIGER(msg, "array", bitLen, extraPasses, bigEndian) as Uint8Array, key_length);

    var digestbytes = _TIGER(result, "array", bitLen, extraPasses, bigEndian) as Uint8Array;
    if (format == "hex") {
        return bytesToHex(digestbytes);
    } else if (format == "buffer") {
        return Buffer.from(digestbytes);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER128(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER128_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER160(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER160_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER192(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER192_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2(message: InputData, format: OutputFormat = arrayType(), bitLen: 128 | 160 | 192 = 192, extraPasses: number = 0, bigEndian: boolean = false): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType(), bitLen: 128 | 160 | 192 = 192, extraPasses: number = 0, bigEndian: boolean = false): string | Uint8Array | Buffer {
    // TIGER192
    const key_length = 64;
    const hash_len = bitLen / 8;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = TIGER2(key, "array", bitLen, extraPasses, bigEndian) as Uint8Array;
    }
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(TIGER2(msg, "array", bitLen, extraPasses, bigEndian) as Uint8Array, key_length);

    var digestbytes = TIGER2(result, "array", bitLen, extraPasses, bigEndian) as Uint8Array;
    if (format == "hex") {
        return bytesToHex(digestbytes);
    } else if (format == "buffer") {
        return Buffer.from(digestbytes);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_128(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_128_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_160(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_160_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_192(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
    message = formatMessage(message);
 ...
 * @returns `string | Uint8Array | Buffer`
 */
export function TIGER2_192_HMAC(message: InputData, key: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
...
export class TIGER {
    ...
    static TIGER = _TIGER;
    static TIGER128 = TIGER128;
    static TIGER128_HMAC = TIGER128_HMAC;
    static TIGER160 = TIGER160;
    static TIGER160_HMAC = TIGER160_HMAC;
    static TIGER192 = TIGER192;
    static TIGER192_HMAC = TIGER192_HMAC;
    static TIGER_HMAC = TIGER_HMAC;

    static TIGER2 = TIGER2;
    static TIGER2_128 = TIGER2_128;
    static TIGER2_128_HMAC = TIGER2_128_HMAC;
    static TIGER2_160 = TIGER2_160;
    static TIGER2_160_HMAC = TIGER2_160_HMAC;
    static TIGER2_192 = TIGER2_192;
    static TIGER2_192_HMAC = TIGER2_192_HMAC;
    static TIGER2_HMAC = TIGER2_HMAC;
    /**
