...
class Hasher {
     ...
     * @constructor
     */
    constructor(options: Options = { length: 0, rounds: 0 }) {
        /**
 ...
 * @param {number} size
 */
function generateSbox(size: number) {
    for (let i = 0; i < size; i++) {
 ...
 */
export class Snefru extends Hasher32be {
    W: number[];
    /**
     * @param {Object} [options]
 ...
 */
export function _SNEFRU(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function SNEFRU128_2(message: InputData, format: OutputFormat = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function SNEFRU256_4(message: InputData, format: OutputFormat = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function SNEFRU128_8(message: InputData, format: OutputFormat = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function SNEFRU256_8(message: InputData, format: OutputFormat = arrayType()): string | Uint8Array | Buffer {
...
export class SNEFRU {
    ...
    static SNEFRU = _SNEFRU;
    static SNEFRU128_2 = SNEFRU128_2;
    static SNEFRU128_8 = SNEFRU128_8;
    static SNEFRU256_4 = SNEFRU256_4;
    static SNEFRU256_8 = SNEFRU256_8;
    /**
