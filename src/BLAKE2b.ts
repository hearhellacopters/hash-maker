...
var BLAKE2B_IV32: Uint32Array;
var SIGMA82: Uint8Array;
var v: Uint32Array;
var m: Uint32Array;

var parameterBlock: Uint8Array;
...
export class Blake2b {
    ...
    constructor(outlen: number, key?: InputData, salt?: InputData, personal?: InputData) {
        ...
        parameterBlock[2] = 1;
        parameterBlock[3] = 1;
        if (salt) parameterBlock.set(salt as Buffer | Uint8Array, 32);
        if (personal) parameterBlock.set(personal as Buffer | Uint8Array, 48);
        ...
        if (key) {
            this.blake2bUpdate(key as Buffer | Uint8Array);

            this.c = 128;
        }
    }

    blake2bUpdate(input: Uint8Array | Buffer) {
...
function blake2bHex(output: Uint8Array) {
 ...
 */
export function BLAKE2b(message: InputData, format: OutputFormat = arrayType(), key?: InputData, bitLen: 128 | 224 | 256 | 384 | 512 = 512, salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
    // preprocess inputs
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b512(message: InputData, format: OutputFormat = arrayType(), key?: InputData, salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b512_HMAC(message: InputData, key?: InputData, format: OutputFormat = arrayType(),  salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b384(message: InputData, format: OutputFormat = arrayType(), key?: InputData, salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b384_HMAC(message: InputData, key?: InputData, format: OutputFormat = arrayType(), salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b256(message: InputData, format: OutputFormat = arrayType(), key?: InputData, salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b256_HMAC(message: InputData, key?: InputData, format: OutputFormat = arrayType(), salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b224(message: InputData, format: OutputFormat = arrayType(), key?: InputData, salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b224_HMAC(message: InputData, key?: InputData, format: OutputFormat = arrayType(), salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
export function BLAKE2b_HMAC(message: InputData, key?: InputData, bitLen: 128 | 224 | 256 | 384 | 512 = 512, format: OutputFormat = arrayType(), salt?: InputData, personal?: InputData): string | Uint8Array | Buffer {
    // preprocess inputs
    const bits = bitLen ? bitLen / 8 : 64;
    message = formatMessage(message);
    // do the math
