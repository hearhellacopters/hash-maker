class Int64 {
    ...
    static copy(dst:Int64, src:Int64) {
        dst.h = src.h;
        dst.l = src.l;
    }

    static shr(dst:Int64, x:Int64, shift:number) {
        dst.l = x.l >>> shift | x.h << 32 - shift;
        dst.h = x.h >>> shift;
    }

    static rotr(dst:Int64, x:Int64, shift:number) {
        dst.l = x.l >>> shift | x.h << 32 - shift;
        dst.h = x.h >>> shift | x.l << 32 - shift;
    }

    static rotl(dst:Int64, x:Int64, shift:number) {
        dst.l = x.h >>> shift | x.l << 32 - shift;
        dst.h = x.l >>> shift | x.h << 32 - shift;
    }

    static add(dst:Int64, x:Int64, y:Int64) {
    ...
    static add4(dst:Int64, a:Int64, b:Int64, c:Int64, d:Int64) {
    ...
    static add5(dst:Int64, a:Int64, b:Int64, c:Int64, d:Int64, e:Int64) {
...
class Sha512 {
    ...
    hash(msg:string|Uint8Array|Buffer, is384:boolean, options?:Options) {
        var digestbytes:any;
        if(typeof msg == 'string'){
            digestbytes = this.wordsToBytes(this.run(this.stringToArray(msg), msg.length * 8))
        } else
        if(arraybuffcheck(msg as Uint8Array|Buffer)){
            digestbytes = this.wordsToBytes(this.run(<unknown> msg as number[], msg.length * 8))
        } else {
    ...
    wordsToBytes(words:number[]):number[] {
 ...
 */
export function SHA512(message:string|Uint8Array|Buffer, options?:Options){
 ...
 * @returns ```string|Uint8Array|Buffer```
 */
export function SHA384(message:string|Uint8Array|Buffer, options?:Options){
