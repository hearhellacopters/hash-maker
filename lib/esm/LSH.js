...
exports.LSH = exports.LSH512_512_HMAC = exports.LSH512_512 = exports.LSH512_384_HMAC = exports.LSH512_384 = exports.LSH512_256_HMAC = exports.LSH512_256 = exports.LSH512_224_HMAC = exports.LSH512_224 = exports.LSH512_HMAC = exports.LSH512 = exports.LSH256_256_HMAC = exports.LSH256_256 = exports.LSH256_224_HMAC = exports.LSH256_224 = exports.LSH256_HMAC = exports.LSH256 = exports.LSH_HMAC = exports._LSH = exports.HMac = exports.Lsh512 = exports.Lsh256 = void 0;
...
;
function toU32(inner, inOff, out, outOff, length) {
...
function toU64(inner, inOff, out, outOff, length) {
    for (let idx = outOff; idx < outOff + length; ++idx, ++inOff) {
...
class Hash {
     ...
     */
    static digest(arg1, arg2, arg3, arg4, arg5) {
...
exports.Lsh256 = Lsh256;
/// IV for precomputed 224-bit output
Lsh256.IV224 = new Int32Array([
...
Lsh256.GAMMA = new Int32Array([0, 8, 16, 24, 24, 16, 8, 0]);
/**
...
exports.Lsh512 = Lsh512;
/// IV for precomputed 224-bit output
Lsh512.IV224 = new BigInt64Array([
...
/// IV for precomputed 256-bit output
Lsh512.IV256 = new BigInt64Array([
...
Lsh512.IV384 = new BigInt64Array([
...
Lsh512.IV512 = new BigInt64Array([
...
Lsh512.GAMMA = new Int32Array([0, 16, 32, 48, 8, 24, 40, 56]);
/**
...
class HMac extends Mac {
    ...
    static digest(algorithm, key, msg) {
 ...
 */
function _LSH(message, bitLen = 256, hashLen = 256, format = arrayType()) {
    if (hashLen > bitLen) {
        hashLen = bitLen;
    }
    //@ts-ignore
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH_HMAC(message, key, bitLen = 256, hashLen = 256, format = arrayType()) {
    if (hashLen > bitLen) {
        hashLen = bitLen;
    }
    //@ts-ignore
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH256(message, hashLen = 256, format = arrayType()) {
    if (hashLen > 256) {
        hashLen = 256;
    }
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH256_HMAC(message, key, hashLen = 256, format = arrayType()) {
    if (hashLen > 256) {
        hashLen = 256;
    }
...
exports.LSH256_HMAC = LSH256_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH256_224(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH256_224_HMAC(message, key, format = arrayType()) {
...
exports.LSH256_224_HMAC = LSH256_224_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH256_256(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH256_256_HMAC(message, key, format = arrayType()) {
...
exports.LSH256_256_HMAC = LSH256_256_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512(message, hashLen = 256, format = arrayType()) {
    if (hashLen > 512) {
        hashLen = 512;
    }
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_HMAC(message, key, hashLen = 256, format = arrayType()) {
    if (hashLen > 512) {
        hashLen = 512;
    }
...
exports.LSH512_HMAC = LSH512_HMAC;
/**
 * Creates a 28 byte LSH of the message as either a hex string, Uint8Array or Buffer. Accepts strings, Uint8Array or Buffer.
 *
 * @param {InputData} message - Message to hash
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_224(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_224_HMAC(message, key, format = arrayType()) {
...
exports.LSH512_224_HMAC = LSH512_224_HMAC;
/**
 * Creates a 32 byte LSH of the message as either a hex string, Uint8Array or Buffer. Accepts strings, Uint8Array or Buffer.
 *
 * @param {InputData} message - Message to hash
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_256(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_256_HMAC(message, key, format = arrayType()) {
...
exports.LSH512_256_HMAC = LSH512_256_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_384(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_384_HMAC(message, key, format = arrayType()) {
...
exports.LSH512_384_HMAC = LSH512_384_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_512(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function LSH512_512_HMAC(message, key, format = arrayType()) {
...
exports.LSH512_512_HMAC = LSH512_512_HMAC;
/**
...
LSH.LSH = _LSH;
LSH.LSH256 = LSH256;
LSH.LSH256_HMAC = LSH256_HMAC;
LSH.LSH256_224 = LSH256_224;
LSH.LSH256_224_HMAC = LSH256_224_HMAC;
LSH.LSH256_256 = LSH256_256;
LSH.LSH256_256_HMAC = LSH256_256_HMAC;
LSH.Lsh512 = Lsh512;
LSH.LSH512 = LSH512;
LSH.LSH512_HMAC = LSH512_HMAC;
LSH.LSH512_224 = LSH512_224;
LSH.LSH512_224_HMAC = LSH512_224_HMAC;
LSH.LSH512_256 = LSH512_256;
LSH.LSH512_256_HMAC = LSH512_256_HMAC;
LSH.LSH512_384 = LSH512_384;
LSH.LSH512_384_HMAC = LSH512_384_HMAC;
LSH.LSH512_512 = LSH512_512;
LSH.LSH512_512_HMAC = LSH512_512_HMAC;
LSH.LSH_HMAC = LSH_HMAC;
