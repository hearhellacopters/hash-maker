...
exports.SNEFRU = exports.SNEFRU256_8 = exports.SNEFRU128_8 = exports.SNEFRU256_4 = exports.SNEFRU128_2 = exports._SNEFRU = exports.Snefru = void 0;
/**
...
class Hasher {
     ...
     * @constructor
     */
    constructor(options = { length: 0, rounds: 0 }) {
...
class Snefru extends Hasher32be {
    ...
    constructor(options) {
        ...
        options = options || { length: 128, rounds: 2 };
        super(options);
        /**
         * Size of block in units
         * @ignore
 ...
 */
function _SNEFRU(message, format = arrayType()) {
    return SNEFRU256_8(message, format);
}
exports._SNEFRU = _SNEFRU;
;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SNEFRU128_2(message, format = arrayType()) {
    const hash = new Snefru({ length: 128, rounds: 2 });
    hash.update(message);
...
exports.SNEFRU128_2 = SNEFRU128_2;
/**
 * Creates a 32 byte SNEFRU/256/4 hash of the message as either a hex string, Uint8Array or Buffer. Accepts strings, Uint8Array or Buffer.
 *
 * @param {InputData} message - Message to hash
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SNEFRU256_4(message, format = arrayType()) {
    const hash = new Snefru({ length: 256, rounds: 4 });
    hash.update(message);
    var digestbytes = hash.finalize();
    if (format == "buffer") {
        return Buffer.from(digestbytes);
...
exports.SNEFRU256_4 = SNEFRU256_4;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SNEFRU128_8(message, format = arrayType()) {
    const hash = new Snefru({ length: 128, rounds: 8 });
    hash.update(message);
    var digestbytes = hash.finalize();
    if (format == "buffer") {
        return Buffer.from(digestbytes);
...
exports.SNEFRU128_8 = SNEFRU128_8;
/**
 * Creates a 32 byte SNEFRU/256/4 hash of the message as either a hex string, Uint8Array or Buffer. Accepts strings, Uint8Array or Buffer.
 *
 * @param {InputData} message - Message to hash
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SNEFRU256_8(message, format = arrayType()) {
    const hash = new Snefru({ length: 256, rounds: 8 });
    hash.update(message);
    var digestbytes = hash.finalize();
    if (format == "buffer") {
        return Buffer.from(digestbytes);
...
exports.SNEFRU256_8 = SNEFRU256_8;
/**
...
SNEFRU.SNEFRU = _SNEFRU;
SNEFRU.SNEFRU128_2 = SNEFRU128_2;
SNEFRU.SNEFRU128_8 = SNEFRU128_8;
SNEFRU.SNEFRU256_4 = SNEFRU256_4;
SNEFRU.SNEFRU256_8 = SNEFRU256_8;
;
//# sourceMappingURL=SNEFRU.js.map