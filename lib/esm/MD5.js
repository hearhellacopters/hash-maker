...
exports.MD5_HMAC = exports.MD5 = void 0;
...
function md5(message) {
    ...
    var m = bytesToWords(message2), l = message2.length * 8, a = 1732584193, b = -271733879, c = -1732584194, d = 271733878;
 ...
 */
function MD5(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD5_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 16;
    ...
    result.set(MD5(msg, "array"), key_length);
    var digestbytes = MD5(result);
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
