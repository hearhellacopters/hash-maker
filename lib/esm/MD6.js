...
exports.MD6_512_HMAC = exports.MD6_512 = exports.MD6_384_HMAC = exports.MD6_384 = exports.MD6_256_HMAC = exports.MD6_256 = exports.MD6_224_HMAC = exports.MD6_224 = exports.MD6_128_HMAC = exports.MD6_128 = exports.MD6_HMAC = exports.MD6 = void 0;
// Internal constants
...
// Core MD6 class
class Md6 {
    constructor(hashbitlen, key, compression, treeMode = false, parallel = false) {
        if (!inited) {
    ...
    getIv(hashbitlen) {
        if (hashbitlen <= 256)
            return new Uint32Array(MD6_IV_256);
        if (hashbitlen <= 384)
            return new Uint32Array(MD6_IV_384);
    ...
    compress(input, iv, key, level, hashbitlen, compression) {
        return this.compressFull(input, iv, key, level, hashbitlen, compression);
    }
    compressFull(input, iv, key, level, hashbitlen, compression) {
    ...
    update(data) {
        ...
        while (offset < bytes.length) {
            ...
            if (this.state.bufferLength === MD6_BLOCK_SIZE) {
                ...
                const compressed = this.compress(words, this.state.iv, this.state.key, this.state.level, this.state.hashbitlen, this.state.compression);
    ...
    digest(format = 'hex') {
        ...
        const finalOutput = this.compress(finalWords, this.state.iv, this.state.key, this.state.level, this.state.hashbitlen, this.state.compression);
 ...
 */
function MD6(message, format = arrayType(), bitLen = 512, compression = 64, treeMode = false, parallel = false) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_HMAC(message, key, bitLen = 512, format = arrayType(), compression = 64, treeMode = false, parallel = false) {
    const hasher = new Md6(bitLen, key, compression, treeMode, parallel);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_HMAC = MD6_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_128(message, format = "array") {
    const hasher = new Md6(128);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_128 = MD6_128;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_128_HMAC(message, key, format = "array") {
    const hasher = new Md6(128, key);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_128_HMAC = MD6_128_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_224(message, format = "array") {
    const hasher = new Md6(224);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_224 = MD6_224;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_224_HMAC(message, key, format = "array") {
    const hasher = new Md6(224, key);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_224_HMAC = MD6_224_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_256(message, format = arrayType()) {
    const hasher = new Md6(256);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_256 = MD6_256;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_256_HMAC(message, key, format = arrayType()) {
    const hasher = new Md6(256, key);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_256_HMAC = MD6_256_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_384(message, format = arrayType()) {
    const hasher = new Md6(384);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_384 = MD6_384;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_384_HMAC(message, key, format = arrayType()) {
    const hasher = new Md6(384, key);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_384_HMAC = MD6_384_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_512(message, format = arrayType()) {
    const hasher = new Md6(512);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_512 = MD6_512;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function MD6_512_HMAC(message, key, format = arrayType()) {
    const hasher = new Md6(512, key);
    hasher.update(message);
    return hasher.digest(format);
}
exports.MD6_512_HMAC = MD6_512_HMAC;
//# sourceMappingURL=MD6.js.map