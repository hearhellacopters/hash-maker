...
exports.BLAKE2s_HMAC = exports.BLAKE2s224_HMAC = exports.BLAKE2s224 = exports.BLAKE2s256_HMAC = exports.BLAKE2s256 = exports.BLAKE2s = exports.Blake2s = void 0;
 ...
 */
function BLAKE2s(message, format = arrayType(), key, bitLen = 256) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function BLAKE2s256(message, format = arrayType(), key) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function BLAKE2s256_HMAC(message, key, format = arrayType()) {
    return BLAKE2s(message, format, key, 256);
}
exports.BLAKE2s256_HMAC = BLAKE2s256_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function BLAKE2s224(message, format = arrayType(), key) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function BLAKE2s224_HMAC(message, key, format = arrayType()) {
    return BLAKE2s(message, format, key, 224);
}
exports.BLAKE2s224_HMAC = BLAKE2s224_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function BLAKE2s_HMAC(message, key, format = arrayType(), bitLen = 256) {
    message = formatMessage(message);
...
exports.BLAKE2s_HMAC = BLAKE2s_HMAC;
