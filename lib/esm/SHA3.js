...
exports.cSHAKE256 = exports.cSHAKE128 = exports._cSHAKE = exports.KMAC256 = exports.KMAC128 = exports._KMAC = exports.SHAKE256 = exports.SHAKE128 = exports._SHAKE = exports.KECCAK512_HMAC = exports.KECCAK512 = exports.KECCAK384_HMAC = exports.KECCAK384 = exports.KECCAK256_HMAC = exports.KECCAK256 = exports.KECCAK224_HMAC = exports.KECCAK224 = exports.KECCAK_HMAC = exports._KECCAK = exports.SHA3_512_HMAC = exports.SHA3_512 = exports.SHA3_384_HMAC = exports.SHA3_384 = exports.SHA3_256_HMAC = exports.SHA3_256 = exports.SHA3_224_HMAC = exports.SHA3_224 = exports.SHA3_HMAC = exports.SHA3 = void 0;
var SHIFT = [0, 8, 16, 24];
var RC;
...
class Keccak {
    ...
    buffer() {
        return this.arrayBuffer(true);
    }
    array() {
        return this.arrayBuffer(false);
    }
}
...
function createShake(bits, outputBits) {
    var SHAKE_PADDING = [31, 7936, 2031616, 520093696];
    return new Keccak(bits, SHAKE_PADDING, outputBits);
}
function createCShake(bits, outputBits, name, secret) {
...
function createKmac(bits, outputBits, key, secret) {
 ...
 */
function SHA3(message, bits = 256, format = "hex") {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_HMAC(message, key, bits = 256, format = "hex") {
    switch (bits) {
        case 224:
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_224(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_224_HMAC(message, key, format = arrayType()) {
    const key_length = 144;
    const hash_length = 28;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = SHA3_224(key, "array");
    }
    if (key.length < key_length) {
    ...
    result.set(SHA3_224(msg, "array"), key_length);
    return SHA3_224(result, format);
}
exports.SHA3_224_HMAC = SHA3_224_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_256(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_256_HMAC(message, key, format = arrayType()) {
    const key_length = 136;
    const hash_length = 32;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = SHA3_256(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_length);
    result.set(outerKey, 0);
    result.set(SHA3_256(msg, "array"), key_length);
    return SHA3_256(result, format);
}
exports.SHA3_256_HMAC = SHA3_256_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_384(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_384_HMAC(message, key, format = arrayType()) {
    const key_length = 104;
    const hash_length = 48;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = SHA3_384(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_length);
    result.set(outerKey, 0);
    result.set(SHA3_384(msg, "array"), key_length);
    return SHA3_384(result, format);
}
exports.SHA3_384_HMAC = SHA3_384_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_512(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHA3_512_HMAC(message, key, format = arrayType()) {
    const key_length = 72;
    const hash_length = 64;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = SHA3_512(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_length);
    result.set(outerKey, 0);
    result.set(SHA3_512(msg, "array"), key_length);
    return SHA3_512(result, format);
}
exports.SHA3_512_HMAC = SHA3_512_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function _KECCAK(message, bits = 256, format = "hex") {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK_HMAC(message, key, bits = 256, format = "hex") {
    switch (bits) {
        case 224:
...
exports.KECCAK_HMAC = KECCAK_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK224(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK224_HMAC(message, key, format = arrayType()) {
    const hash_len = 28;
    const key_length = 200 - 2 * hash_len;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = KECCAK224(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    result.set(outerKey, 0);
    result.set(KECCAK224(msg, "array"), key_length);
    return KECCAK224(result, format);
}
exports.KECCAK224_HMAC = KECCAK224_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK256(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK256_HMAC(message, key, format = arrayType()) {
    const hash_len = 32;
    const key_length = 200 - 2 * hash_len;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = KECCAK256(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(KECCAK256(msg, "array"), key_length);
    return KECCAK256(result, format);
}
exports.KECCAK256_HMAC = KECCAK256_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK384(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK384_HMAC(message, key, format = arrayType()) {
    const hash_len = 48;
    const key_length = 200 - 2 * hash_len;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = KECCAK384(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(KECCAK384(msg, "array"), key_length);
    return KECCAK384(result, format);
}
exports.KECCAK384_HMAC = KECCAK384_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK512(message, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KECCAK512_HMAC(message, key, format = arrayType()) {
    const hash_len = 64;
    const key_length = 200 - 2 * hash_len;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = KECCAK512(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(KECCAK512(msg, "array"), key_length);
    return KECCAK512(result, format);
}
exports.KECCAK512_HMAC = KECCAK512_HMAC;
/**
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function _SHAKE(message, bits = 256, outputBits, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHAKE128(message, outputBits = 256, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function SHAKE256(message, outputBits = 256, format = arrayType()) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function _KMAC(message, key, inputBits = 256, outputBits = 256, format = arrayType(), secret) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KMAC128(message, key, outputBits = 256, format = arrayType(), secret) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function KMAC256(message, key, outputBits = 256, format = arrayType(), secret) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function _cSHAKE(message, inputBits = 256, outputBits, format = arrayType(), name, secret) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function cSHAKE128(message, outputBits, format = arrayType(), name, secret) {
 ...
 * @returns `string | Buffer | Uint8Array`
 */
function cSHAKE256(message, outputBits, format = arrayType(), name, secret) {
