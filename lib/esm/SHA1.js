...
exports.SHA1_HMAC = exports.SHA1 = void 0;
function arrayType() {
...
function sha1(message) {
    ...
    var m = bytesToWords(message2), l = message.length * 8, w = [], H0 = 0x67452301, H1 = 0xefcdab89, H2 = 0x98badcfe, H3 = 0x10325476, H4 = 0xc3d2e1f0;
    // Padding
    m[l >> 5] |= 0x80 << (24 - l % 32);
    m[((l + 64 >>> 9) << 4) + 15] = l;
 ...
 */
function SHA1(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA1_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 20;
