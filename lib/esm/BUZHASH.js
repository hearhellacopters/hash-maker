...
exports.BUZHASH = exports._BUZHASH = void 0;
...
class BuzHash {
    ...
    hash_byte(b) {
        ...
        if (this.overflow) {
            var toshift = BuzHash.bytehash[this.buf[this.bufpos]];
            if (this.bshiftn == 0) {
                state ^= toshift;
            }
            else {
                state ^= (toshift << this.bshiftn) | (toshift >> this.bshiftm);
            }
        }
        this.buf[this.bufpos] = b;
        this.bufpos += 1;
        state ^= BuzHash.bytehash[b];
        this.state = state;
        return state;
    }
    update(message) {
...
BuzHash.bytehash = new Uint8Array([
 ...
 * @returns `number`
 */
function _BUZHASH(message, seed = 17) {
    const hash = new BuzHash(seed);
    hash.update(message);
    return hash.digest();
}
exports._BUZHASH = _BUZHASH;
/**
...
exports.BUZHASH = BUZHASH;
BUZHASH.BuzHash = BuzHash;
BUZHASH.BUZHASH = _BUZHASH;
//# sourceMappingURL=BUZHASH.js.map