...
exports.WHIRLPOOL = exports.WHIRLPOOLT_HMAC = exports.WHIRLPOOLT = exports.WHIRLPOOL0_HMAC = exports.WHIRLPOOL0 = exports.WHIRLPOOL_HMAC = exports._WHIRLPOOL = exports.Whirlpool = void 0;
...
class Hasher {
     ...
     * @constructor
     */
    constructor(options = { type: "", rounds: 10 }) {
...
class Whirlpool extends Hasher32be {
     ...
     */
    finalize() {
        this.addPaddingISO7816(this.state.message.length < 32 ?
 ...
 */
function _WHIRLPOOL(message, format = arrayType()) {
...
function WHIRLPOOL_HMAC(message, key, format = arrayType()) {
    ...
    result.set(_WHIRLPOOL(msg, "array"), key_length);
    var digestbytes = _WHIRLPOOL(result, "array");
    if (format == "buffer") {
        return Buffer.from(digestbytes);
    }
    else if (format == "hex") {
...
exports.WHIRLPOOL_HMAC = WHIRLPOOL_HMAC;
;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function WHIRLPOOL0(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function WHIRLPOOL0_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 64;
    key = Hasher.convertToUint8Array(key);
    message = Hasher.convertToUint8Array(message);
    if (key.length > key_length) {
        key = WHIRLPOOL0(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(WHIRLPOOL0(msg, "array"), key_length);
    var digestbytes = WHIRLPOOL0(result, "array");
    if (format == "buffer") {
        return Buffer.from(digestbytes);
    }
    else if (format == "hex") {
...
exports.WHIRLPOOL0_HMAC = WHIRLPOOL0_HMAC;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function WHIRLPOOLT(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function WHIRLPOOLT_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 64;
    key = Hasher.convertToUint8Array(key);
    message = Hasher.convertToUint8Array(message);
    if (key.length > key_length) {
        key = WHIRLPOOLT(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(WHIRLPOOLT(msg, "array"), key_length);
    var digestbytes = WHIRLPOOLT(result, "array");
    if (format == "buffer") {
        return Buffer.from(digestbytes);
    }
    else if (format == "hex") {
...
exports.WHIRLPOOLT_HMAC = WHIRLPOOLT_HMAC;
;
/**
...
WHIRLPOOL.WHIRLPOOL = _WHIRLPOOL;
WHIRLPOOL.WHIRLPOOL_HMAC = WHIRLPOOL_HMAC;
WHIRLPOOL.WHIRLPOOL0 = WHIRLPOOL0;
WHIRLPOOL.WHIRLPOOL0_HMAC = WHIRLPOOL0_HMAC;
WHIRLPOOL.WHIRLPOOLT = WHIRLPOOLT;
WHIRLPOOL.WHIRLPOOLT_HMAC = WHIRLPOOLT_HMAC;
;
