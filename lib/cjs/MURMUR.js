...
exports.MURMUR = exports.MURMUR2B_64 = exports.MURMUR2A_64 = exports.MURMUR2A_32 = exports.MURMUR2_32 = exports.MURMUR1 = void 0;
const MURMUR3_1 = require("./MURMUR3");
 ...
 * @returns
 */
function MURMUR1(message, seed = 0) {
 ...
 * @returns `number`
 */
function MURMUR2_32(message, seed = 0) {
 ...
 * @returns `number`
 */
function MURMUR2A_32(message, seed = 0) {
    var data = formatMessage(message);
    var len = data.length;
...
exports.MURMUR2A_32 = MURMUR2A_32;
/**
 ...
 * @returns `bigint`
 */
function MURMUR2A_64(message, seed = BigInt(0)) {
    var data = formatMessage(message);
...
exports.MURMUR2A_64 = MURMUR2A_64;
/**
 ...
 * @returns `bigint`
 */
function MURMUR2B_64(message, seed = BigInt(0)) {
    var data = formatMessage(message);
    var len = data.length;
...
exports.MURMUR2B_64 = MURMUR2B_64;
/**
...
MURMUR.MURMUR1 = MURMUR1;
MURMUR.MURMUR2_32 = MURMUR2_32;
MURMUR.MURMUR2A_32 = MURMUR2A_32;
MURMUR.MURMUR2A_64 = MURMUR2A_64;
MURMUR.MURMUR2B_64 = MURMUR2B_64;
MURMUR.MURMUR3_X86_32 = MURMUR3_1.MURMUR3_X86_32;
MURMUR.MURMUR3_X86_128 = MURMUR3_1.MURMUR3_X86_128;
MURMUR.MURMUR3_X64_128 = MURMUR3_1.MURMUR3_X64_128;
