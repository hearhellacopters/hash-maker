...
exports.SHA224_HMAC = exports.SHA224 = exports.SHA256_DOUBLE = exports.SHA256_HMAC = exports.SHA256 = void 0;
var K = [];
function arrayType() {
 ...
 */
function SHA256(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA256_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 32;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = SHA256(key, "array");
    }
    if (key.length < key_length) {
    ...
    result.set(SHA256(msg, "array"), key_length);
    var digestbytes = SHA256(result, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA256_DOUBLE(message, format = arrayType()) {
    var message2 = formatMessage(message);
    var n = 2;
    var nPrime = 0;
    while (nPrime < 64) {
...
exports.SHA256_DOUBLE = SHA256_DOUBLE;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA224(message, format = arrayType()) {
    var message2 = formatMessage(message);
    var n = 2;
    var nPrime = 0;
    while (nPrime < 64) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA224_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    ...
    result.set(outerKey, 0);
    result.set(SHA224(msg), key_length);
    var digestbytes = SHA224(result);
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
