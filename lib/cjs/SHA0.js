...
exports.SHA0_HMAC = exports.SHA0 = void 0;
function arrayType() {
...
function writeInt32BE(array, value, index) {
...
class Sha extends Hash {
    constructor(blockSize = 64, finalSize = 56) {
...
function readInt32BE(array, index) {
 ...
 */
function SHA0(message, format = arrayType()) {
    const hash = new Sha();
    hash.update(message);
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA0_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 20;
    ...
    result.set(SHA0(msg, "array"), key_length);
    var digestbytes = SHA0(result, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
...
exports.SHA0_HMAC = SHA0_HMAC;
//# sourceMappingURL=SHA0.js.map