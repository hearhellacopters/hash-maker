...
exports.ARGON2 = exports.ARGON2U = exports.ARGON2ID = exports.ARGON2I = exports.ARGON2D = exports._ARGON2 = void 0;
 ...
 */
function _ARGON2(password, salt, format = arrayType(), time = 1, memory = 1024, hashLen = 32, parallelism = 1, type = ArgonType.Argon2d) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function ARGON2D(password, salt, format = arrayType(), time = 1, memory = 1024, hashLen = 32, parallelism = 1) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function ARGON2I(password, salt, format = arrayType(), time = 1, memory = 1024, hashLen = 32, parallelism = 1) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function ARGON2ID(password, salt, format = arrayType(), time = 1, memory = 1024, hashLen = 32, parallelism = 1) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function ARGON2U(password, salt, format = arrayType(), time = 1, memory = 1024, hashLen = 32, parallelism = 1) {
