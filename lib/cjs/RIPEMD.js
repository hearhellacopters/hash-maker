...
exports.RIPEMD = exports.RIPEMD_HMAC = exports._RIPEMD = exports.RIPEMD320_HMAC = exports.RIPEMD320 = exports.RIPEMD256_HMAC = exports.RIPEMD256 = exports.RIPEMD160_HMAC = exports.RIPEMD160 = exports.RIPEMD128_HMAC = exports.RIPEMD128 = exports.Ripemd = void 0;
function arrayType() {
    ...
    process() {
        while (this.state.message.length >= this.blockSizeInBytes) {
            ...
            for (let b = 0; b < this.blockSizeInBytes; b += 4) {
                ...
                this.blockUnits.push(this.state.message[b] |
 ...
 */
function RIPEMD128(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD128_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 16;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = RIPEMD128(key, "array");
    }
    if (key.length < key_length) {
    ...
    result.set(RIPEMD128(msg, "array"), key_length);
    var digestbytes = RIPEMD128(result, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
...
exports.RIPEMD128_HMAC = RIPEMD128_HMAC;
;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD160(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD160_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 20;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = RIPEMD160(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(RIPEMD160(msg, "array"), key_length);
    var digestbytes = RIPEMD160(result, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
...
exports.RIPEMD160_HMAC = RIPEMD160_HMAC;
;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD256(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD256_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 32;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = RIPEMD256(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(RIPEMD256(msg, "array"), key_length);
    var digestbytes = RIPEMD256(result, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
...
exports.RIPEMD256_HMAC = RIPEMD256_HMAC;
;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD320(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD320_HMAC(message, key, format = arrayType()) {
    const key_length = 64;
    const hash_len = 40;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = RIPEMD320(key, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(RIPEMD320(msg, "array"), key_length);
    var digestbytes = RIPEMD320(result, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
...
exports.RIPEMD320_HMAC = RIPEMD320_HMAC;
;
/**
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function _RIPEMD(message, bits = 128, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function RIPEMD_HMAC(message, key, bits = 128, format = arrayType()) {
    const key_length = 64;
    const hash_len = bits / 8;
    key = formatMessage(key);
    message = formatMessage(message);
    if (key.length > key_length) {
        key = _RIPEMD(key, bits, "array");
    }
    if (key.length < key_length) {
        const tmp = new Uint8Array(key_length);
        tmp.set(key, 0);
    ...
    var result = new Uint8Array(key_length + hash_len);
    result.set(outerKey, 0);
    result.set(_RIPEMD(msg, bits, "array"), key_length);
    var digestbytes = _RIPEMD(result, bits, "array");
    if (format == "hex") {
        return bytesToHex(digestbytes);
    }
    else if (format == "buffer") {
...
exports.RIPEMD_HMAC = RIPEMD_HMAC;
;
/**
...
RIPEMD.RIPEMD = _RIPEMD;
RIPEMD.RIPEMD128 = RIPEMD128;
RIPEMD.RIPEMD128_HMAC = RIPEMD128_HMAC;
RIPEMD.RIPEMD160 = RIPEMD160;
RIPEMD.RIPEMD160_HMAC = RIPEMD160_HMAC;
RIPEMD.RIPEMD256 = RIPEMD256;
RIPEMD.RIPEMD256_HMAC = RIPEMD256_HMAC;
RIPEMD.RIPEMD320 = RIPEMD320;
RIPEMD.RIPEMD320_HMAC = RIPEMD320_HMAC;
RIPEMD.RIPEMD_HMAC = RIPEMD_HMAC;
;
