...
exports.SHA512_224_HMAC = exports.SHA512_256_HMAC = exports.SHA512_256 = exports.SHA512_224 = exports.SHA384_HMAC = exports.SHA384 = exports.SHA512_HMAC = exports.SHA512 = void 0;
function arrayType() {
...
class Sha512 {
    constructor(bits, sharedMemory = false) {
...
class HmacSha512 extends Sha512 {
    constructor(key, bits, sharedMemory) {
 ...
 */
function SHA512(message, format = arrayType(), outputBits = 512) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA512_HMAC(message, key, format = arrayType(), outputBits = 512) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA384(message, format = arrayType(), outputBits = 384) {
    const hash = new Sha512(outputBits, true);
    hash.update(message);
    if (format == 'hex') {
        return hash.hex();
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA384_HMAC(message, key, format = arrayType(), outputBits = 384) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA512_224(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA512_256(message, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA512_256_HMAC(message, key, format = arrayType()) {
 ...
 * @returns `string|Uint8Array|Buffer`
 */
function SHA512_224_HMAC(message, key, format = arrayType()) {
